<template>
  <div class="min-h-screen bg-gray-100 p-6">
    <div class="max-w-6xl mx-auto">
      <h1 class="text-3xl font-bold mb-8">Create Your Design</h1>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-6">
            ...
            <form @submit.prevent="generateDesign" class="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="Example: A modern mountain landscape with sunset colors, minimalist style"
                  required
                ></textarea>
              </div>
          ...
          <div v-if="generatedDesign" class="bg-white rounded-lg shadow p-6">
            <h2 class="text-xl font-semibold mb-4">Original Design</h2>
        ...
        <div v-if="generatedDesign" class="space-y-6">
          ...
          <!-- 注文オプション -->
          <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-xl font-semibold mb-4">Order Options</h2>
            <div class="space-y-4">
              <!-- サイズ選択 -->
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">
      ...
      </div> <!-- 修正済み：右側の v-if="generatedDesign" を閉じる -->
    </div>
  </div>
</template>
